...
const attachment = new Discord.MessageAttachment('https://media.discordapp.net/attachments/846277426962497567/846810803554091068/kurallar-png.png ');
hook.send(`📢 \`${message.guild.name}\` **Sunucu Kuralları**

\`¤\` **Reklam** Sunucu **İçi** Ve **Özelden** Yasaktır.
